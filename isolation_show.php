    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="isolation_show.php">Isolation Wards</a>
        ...
        <div class="col-lg-12">
            <br>
            <h1 class="text-grey text-center">Isolation wards data</h1>
            <br>
            <br>
        ...
        ?>
                ...
                <tr>
                        ...
                        <td><button class="btn-danger btn"> <a href="delete_iso.php?ward_id=<?php echo $res['Ward_id']; ?>" class="text-white"> Delete </a> </button></td>
                        <td><button class="btn-primary btn"> <a href="update_iso.php?ward_id=<?php echo $res['Ward_id']; ?>" class="text-white"> Update </a> </button></td>
                </tr>
                <?php
                }
                CloseCon($conn);
            ...
            <button onclick="location.href = 'iso_form.php';" type="submit" name="submit" >Add new record</button>
            </div>
        ...
        <br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="isolation_show.php">Isolation Wards</a></li>
