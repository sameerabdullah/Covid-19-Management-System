    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="update_pat.php">Patients Record</a>
...
<br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="update_pat.php">Patients Record</a></li>
...
if(isset($_POST['done']))
{
        ...
        $query = "UPDATE `patient` SET `P_id`='$id',`Name`='$name',`Status`='$status',`Address`='$address',`Ward_id`='$ward_id',`Manager_id`='$manager_id',`Phone_no`='$phone_no',`Region_id`='$region_id' WHERE P_id=$id";
