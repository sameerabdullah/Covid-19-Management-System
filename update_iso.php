    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="update_iso.php">Isolation Wards</a>
...
<br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="update_iso.php">Isolation Wards</a></li>
...
if(isset($_POST['done']))
{
        ...
        $query = "UPDATE `isolation_ward` SET `Ward_id`=$ward_id,`Capacity`=$capacity,`Manager_id`=$manager_id,`Centre_id`=$centre_id WHERE Ward_id=$ward_id";
