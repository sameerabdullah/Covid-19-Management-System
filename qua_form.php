    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="qua_form.php">Quarantine Wards</a>
...
<br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="qua_form.php">Quarantine Wards</a></li>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `quarantine_ward`(`Ward_id`, `Capacity`, `Manager_id`, `Centre_id`) VALUES ('$ward_id','$capacity','$manager_id','$centre_id')";
