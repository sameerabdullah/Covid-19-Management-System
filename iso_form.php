    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="iso_form.php">Isolation Wards</a>
        ...
        <h1 class="text-white text-center">Isolation ward form</h1>
        </div>
        <br>
...
<br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="iso_form.php">Isolation Wards</a></li>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `isolation_ward`(`Ward_id`, `Capacity`, `Manager_id`, `Centre_id`) VALUES ('$ward_id','$capacity','$manager_id','$centre_id')";
